...
import { loginUsers } from "./dummydata";
            ...
            try {
                ...
                if (user) {
                    ...
                    authContext.authDispatch({
                        type: authContext.ActionTypes.LOGIN,
                        payload: {
                            user: { first_name: 'Kshitiz', last_name: 'Gupta', role: user.role },
                            token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOiI4NjQwMCIsInVzZXIiOnsiZmlyc3RfbmFtZSI6IktzaGl0aXoiLCJsYXN0X25hbWUiOiJHdXB0YSJ9fQ.7cuOBcnh_GW_At0i3u1AGjGOgzVqou-vwJN7kRn1o5s',
